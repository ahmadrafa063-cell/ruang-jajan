    ...
    >
      ...
      >
        ...
        <motion.span
          ...
          className="absolute right-full mr-4 bg-slate-900 text-white px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest whitespace-nowrap pointer-events-none"
        >
          Order via Shopee
        </motion.span>
      </motion.a>
