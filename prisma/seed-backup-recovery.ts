...
async function main() {
     ...
     const bestSellerBadge = badges.find(b => b.name === ProductBadge.BEST_SELLER)!;
     const newBadge = badges.find(b => b.name === ProductBadge.NEW)!;
     const spicyBadge = badges.find(b => b.name === ProductBadge.SPICY)!;
